...
const tournamentLocations: TournamentLocation[] = [
  ...
  },
  {
    ...
    schoolHomeRooms: [
      { schoolName: "South Forsyth HS", homeRooms: ["207"] },
      { schoolName: "The Westminster Schools", homeRooms: ["107"] },
      { schoolName: "Veterans HS", homeRooms: ["309"] }
    ],
  },
  {
    label: "Howey",
  ...
  },
  {
    ...
    schoolHomeRooms: [
      ...
      { schoolName: "Savannah Christian Prep", homeRooms: ["169"] },
      { schoolName: "Southeast Bulloch HS", homeRooms: ["170"] },
      { schoolName: "St. Mary's Academy", homeRooms: ["317"] },
  ...
  },
  {
    ...
    schoolHomeRooms: [
      ...
      { schoolName: "Lakeside (Evans) HS", homeRooms: ["C241"] },
      { schoolName: "Lambert HS", homeRooms: ["C340"] },
      { schoolName: "North Gwinnett HS", homeRooms: ["E361"] },
      { schoolName: "Northgate HS", homeRooms: ["E283"] },
      { schoolName: "Northview HS", homeRooms: ["C341"] },
      { schoolName: "River Ridge HS", homeRooms: ["C457"] },
      { schoolName: "RMSST", homeRooms: ["C456"] },
    ],
  },
  {
    ...
    schoolHomeRooms: [
      { schoolName: "Walton HS", homeRooms: ["260"] },
      { schoolName: "Wheeler HS", homeRooms: ["259"] },
