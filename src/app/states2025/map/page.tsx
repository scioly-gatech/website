...
import {
  ...
  transportLocations,
  foodLocations
} from "../../../../data/locations/state2025Locations";
              ...
              {tournamentLocations.map((tournamentLocation) => {
                ...
                return (
                  <div className="mb-2" key={tournamentLocation.label}>
                    ...
                    <a className="text-sky-400 hover:opacity-50 hover:cursor-pointer" target="__blank" href={tournamentLocation.mapLink}>Google Maps</a>
                    <div>
                      <ul>
              ...
              {transportLocations.map((transportLocation) => {
                return (
                  <div className="mb-2" key={transportLocation.label}>
                    ...
                    <a className="text-sky-400 hover:opacity-50 hover:cursor-pointer" target="__blank" href={transportLocation.mapLink}>Google Maps</a>
                  </div>
                );
              })}
            </div>
