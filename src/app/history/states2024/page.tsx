...
const Countdown = () => {
  ...
  return(<p className="p-8 bg-darkOrange lg:w-1/4 text-2xl text-center m-4 shadow-xl shadow-white"><span className="font-bold px-1 text-white"> {remaining} </span> Days Until <span className="font-bold">2024 State Tournament</span>!</p>)
}
      ...
      <div className="text-white bg-[url('/images/2024/States/states-24.jpg')] p-12 w-full">
        ...
        <motion.div
          ...
          >
              ...
              <h1 className={`border-8 border-lightOrange lg:p-8 tracking-wide text-center text-4xl lg:text-6xl ${play.className} drop-shadow-titleShadow`}>States 2024</h1>
              </div>
        </motion.div>
        </AnimatePresence>
      </div>
